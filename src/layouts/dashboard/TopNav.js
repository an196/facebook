		...
		>
			<Tooltip lable={item.name}>
				<div className='h-full'>
					<span
						className={`w-[130px] flex justify-center items-center h-[52px] hover:bg-[#303031] rounded-xl`}
					>
						<span className='menu-item'>{item.icon}</span>
					</span>
				</div>
				{item.board}
			</Tooltip>
...
function TopNav() {
	...
	return (
		...
		>
			...
			<span
				className='flex flex-row justify-end items-center space-x-2 w-[360px] cursor-pointer relative'
				id='area3'
			>

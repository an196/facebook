            ...
            <div className='w-[500px] bg-[#242526]  block rounded-lg'>
                ...
                <div className='mx-4'>
                    ...
                    <div className={`w-full flex flex-col justify-between pb-2 ${textMode === '' && 'h-[154px]'}`}>
                        ...
                        `}>
                            <div aria-label='Hiển thị các tùy chọn phông nền'
                                className={`w-[38px] h-[38px] cursor-pointer ${textMode === textmode.size2 && 'hidden'}`}
                            >
                    ...
                    <div className='w-full h-[142px] py-4'>
                        <div
                            ...
                            px-4'
                        >
                            <span className='text-[15px] font-semibold text-[#e4e6eb] cursor-pointer'>Thêm vào bài viết của bạn</span>

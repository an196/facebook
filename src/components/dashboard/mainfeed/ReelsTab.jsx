...
const NextReel = () => {
	return (
		<div className='relative w-[112.5px] h-[200px] float-left flex-none cursor-pointer group border rounded-xl border-[#393a3b]
     hover:bg-white/10 duration-300 transition-all ease-in-out'>
			<div className='flex flex-col h-full w-full items-center justify-center'>
				...
				<span className='break-words text-[15px] font-medium text-[#E4E6EB] text-center mt-3'>Xem thêm thước phim</span>
			</div>
		</div>
	);
};

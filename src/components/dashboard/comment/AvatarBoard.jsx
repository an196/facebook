...
function AvatarBoard() {
    return (
        <>
            <div className='w-[351px] h-[431px] absolute bottom-[100%] right-[100%] translate-x-[16px] -translate-y-[10px] z-50
            ...
            <div className='w-[21px] h-[12px] transform -scale-x-100 scale-y-100 absolute bottom-[100%] right-[100%] translate-x-[16px] 

...
export const friendComments = [
	{
		...
		sticker: {
			...
			img: 'https://firebasestorage.googleapis.com/v0/b/facebook-a9c10.appspot.com/o/sticker_fullsize%2F68277375_2419773764924732_2269613864855273472_n.png?alt=media&token=cc89e732-d668-4d8b-92c3-9efb0ae8356d',
			size: {
				width: 240,
				height: 240,
			},
		...
		reply: [
			{
				...
				img: 'https://firebasestorage.googleapis.com/v0/b/facebook-a9c10.appspot.com/o/michael-dam-mEZ3PoFGs_k-unsplash.jpg?alt=media&token=1f6e25a3-9158-4a36-bef9-2a43c48a12a0',
				timeComment: '9 giờ',
				content: 'Vào rạng sáng nay, Apple không thèm phát hành ',
				reply: [
					{
						_id: '1-1-1',
						_idUser: '01234567891',
...
export const userComments = [
	{
		...
		timeComment: '9 giờ',
		content:
			'Vào rạng sáng nay, Apple tiếp tục phát hành bản beta thứ tư của iOS 16.2 và iPadOS 16.2 cho cả nhà phát triển và người dùng đăng ký tham gia chương trình thử nghiệm công khai. Với bản cập nhật này, phần lớn những thay đổi sẽ tập',
		reply: [
			{
				name: 'Ng.Trần Lê Dương',
				img: 'https://scontent.fsgn5-9.fna.fbcdn.net/v/t39.30808-1/315418083_177437744872747_8232011748455814230_n.jpg?stp=cp0_dst-jpg_p40x40&_nc_cat=1&ccb=1-7&_nc_sid=c6021c&_nc_ohc=LlQGPtbI4PMAX-UDOa7&_nc_ht=scontent.fsgn5-9.fna&oh=00_AfCIUqiFktpnvJHPEekIuXcQvvp1XIGfJsNvuZqcsl9qiA&oe=638F577F',
